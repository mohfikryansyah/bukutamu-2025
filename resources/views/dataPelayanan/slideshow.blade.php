<div id="gallery" class="relative max-w-xl mx-auto p-5 bg-red-300" data-carousel="slide">
    <!-- Carousel wrapper -->
    <div class="relative h-56 overflow-hidden rounded-lg md:h-96 bg-blue-500 ">
         <!-- Item 1 -->
    ...
    <!-- Slider controls -->
    <button type="button" class="absolute top-0 start-4 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
        <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-black/50 dark:bg-gray-800/30 group-hover:bg-black/70 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-black/75 dark:group-focus:ring-black/70 group-focus:outline-none transition-all">
    ...
    <button type="button" class="absolute top-0 end-4 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-next>
        <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-black/50 dark:bg-gray-800/30 group-hover:bg-black/70 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-black/75 dark:group-focus:ring-black/70 group-focus:outline-none transition-all">
            <svg class="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
